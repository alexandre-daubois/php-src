...
PHP_INI_BEGIN()
	...
	PHP_INI_ENTRY("openssl.allow_self_signed", "0", PHP_INI_PERDIR, NULL)
	PHP_INI_ENTRY("openssl.verify_peer", NULL, PHP_INI_PERDIR, NULL)
	PHP_INI_ENTRY("openssl.verify_peer_name", NULL, PHP_INI_PERDIR, NULL)
