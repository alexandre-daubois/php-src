--TEST--
GH-19134: OpenSSL INI options affect verification behavior
--EXTENSIONS--
openssl
--SKIPIF--
<?php
...
--FILE--
<?php
$certFile = __DIR__ . DIRECTORY_SEPARATOR . 'gh19134_test.pem.tmp';
...
$clientCode = <<<'CODE'
    ...
    echo "Connection with INI defaults: " . ($result ? "SUCCESS" : "FAILED") . "\n";
    if ($result) {
        fclose($result);
    }
CODE;
...
--CLEAN--
<?php
@unlink(__DIR__ . DIRECTORY_SEPARATOR . 'gh19134_test.pem.tmp');
?>
--EXPECT--
openssl.verify_peer: 0
openssl.verify_peer_name: 0
